...
export default function Card({photo, text}: ICard) {
  return (
    <div>
      <div className="group rounded-t border-sky-300 border-4 h-32 w-full shadow-md shadow-slate-200 flex justify-center hover:cursor-pointer hover:bg-slate-900" >
