...
export default function Card({photo, text}: ICard) {
  return (
    <div className="w-full flex flex-col">
      <div className="group rounded-t border-sky-300 border-2 h-28 w-full shadow-md shadow-slate-200 flex justify-center hover:cursor-pointer hover:bg-slate-900" >
